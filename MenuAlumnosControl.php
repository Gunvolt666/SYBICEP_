          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="almacen/articulo"><i class="fa fa-circle-o"></i>Libros</a></li>
                <li><a href="almacen/categoria"><i class="fa fa-circle-o"></i>Detalles</a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="MenuUsuariosControl.php"><i class="fa fa-circle-o"></i>Usuarios</a></li>
